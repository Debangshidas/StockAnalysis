...
Original file is located at
    https://colab.research.google.com/drive/138EgwAQMYCKjHU0463UyU_3foYxE_sMB
"""
...
rangeselector=dict(
buttons=list([
dict(count=1, label="im", step="month", stepmode="backward"),
...
figure = px.scatter(data, x= 'Date', y='Close', range_x=['2020-07-12', '2022-07-11'],
